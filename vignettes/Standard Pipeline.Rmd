...
# Standard pipeline
```{r}
event_profiles <- gutbehaviour::EventProfiles_all(P.DATA, 16, 4, factor.freeze = 0.2, factor.flight = 3)
```
...
```{r}
raster <- gutbehaviour::various_lm_plots(processed_event_prof,time_intervals = P.DATA$time_intervals, size_parameter = 1)
```
